...
const ComplianceOverviewContent = () => (
    <section id="sec8-compliance-overview" className="py-12 scroll-mt-24">
        <h2 className="mb-6 text-3xl font-bold text-gray-800">Section 8 Company Compliance - Overview</h2>
        ...
        <h3 className="mb-6 text-2xl font-bold text-gray-800">Tax and Structural Identity</h3>
        <div className="grid gap-6 md:grid-cols-2">
            <div className="p-5 bg-[#E6F0F6] rounded-xl shadow-md border-l-4 border-[#022B50]">
                <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><Briefcase className="w-6 h-6 text-[#022B50]"/> Corporate Structure</h4>
            ...
            <div className="p-5 bg-[#E6F0F6] rounded-xl shadow-md border-l-4 border-[#022B50]">
                <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><TrendingUp className="w-6 h-6 text-[#022B50]"/> Tax Exemptions</h4>
...
const ComplianceBenefitsContent = () => (
    <section id="sec8-compliance-benefits" className="py-12 scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-gray-800">Benefits of Diligent Section 8 Company Compliance</h3>
...
const ComplianceDocumentsContent = () => (
    <section id="sec8-compliance-documents" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Documents Required for Compliance & Timelines</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Core Compliance Documents Checklist:</h4>
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Key Annual Filing Timelines (Statutory Due Dates)</h4>
        <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-300">
                <thead className="bg-[#E6F0F6]">
                    <tr>
                        <th className="px-4 py-2 text-xs font-bold text-left text-gray-700 uppercase">Compliance Form</th>
                        <th className="px-4 py-2 text-xs font-bold text-left text-gray-700 uppercase">Document/Act</th>
                        <th className="px-4 py-2 text-xs font-bold text-left text-gray-700 uppercase">Statutory Deadline</th>
                    </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                    {complianceTimelines.map((row, i) => (
                        <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                            ...
                            <td className="px-4 py-3 text-sm font-medium text-gray-700">{row.deadline}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
...
const ComplianceMandatoryContent = () => (
    <section id="sec8-compliance-mandatory" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Mandatory Annual Compliance Checklist</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
...
const ComplianceEventContent = () => (
    <section id="sec8-compliance-event" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Event-Based Annual Compliances & Post-Compliance</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {eventBasedCompliances.map((item, i) => (
                <div key={i} className="p-5 bg-white border border-gray-200 shadow-sm rounded-xl">
        ...
        <h4 className="mt-12 mb-6 text-2xl font-bold text-gray-800">Key Post-Incorporation Compliances</h4>
...
const CompliancePenaltiesContent = () => (
    <section id="sec8-compliance-penalties" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Penalties and Due Dates for Non-Compliance</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <div className="grid gap-6 mb-12 md:grid-cols-2">
            {penaltyDetails.map((item, i) => (
                <div key={i} className="p-5 border border-red-500 shadow-sm bg-red-50 rounded-xl">
                    ...
                    <p className="text-sm font-medium text-gray-600">**Penalty:** {item.penalty}</p>
                    {item.date !== "N/A" && <p className="mt-1 text-xs text-gray-500">Applicable Form/Area: {item.date}</p>}
                </div>
            ))}
        </div>

        <h4 className="mb-6 text-2xl font-bold text-gray-800">Statutory Due Date Summary</h4>
        <p className="max-w-4xl mb-4 text-lg text-gray-700">
        ...
        <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-300">
                <thead className="bg-amber-500/20">
                    <tr>
                        <th className="px-4 py-2 text-xs font-bold text-left text-gray-700 uppercase">Form No</th>
                        <th className="px-4 py-2 text-xs font-bold text-left text-gray-700 uppercase">Compliance</th>
                        <th className="px-4 py-2 text-xs font-bold text-left text-gray-700 uppercase">Statutory Due Date</th>
                    </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                    <tr className="bg-white">
                        ...
                        <td className="px-4 py-3 text-sm font-semibold text-red-600">Within 30 days of the AGM</td>
                    </tr>
                    <tr className="bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm font-semibold text-red-600">Within 60 days of the AGM</td>
                    </tr>
                    <tr className="bg-white">
                        ...
                        <td className="px-4 py-3 text-sm font-semibold text-red-600">30 September</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
const ComplianceFAQsContent = ({ faqs, faqOpen, setFaqOpen }) => (
    <section id="sec8-compliance-faqs" className="max-w-5xl py-12 mx-auto scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-center text-gray-800">FAQ's on Section 8 Company Compliance</h3>
                ...
                <div className="relative px-4 pt-12 mx-auto max-w-7xl md:px-8">
                    ...
                    <div className="relative z-20 flex flex-col items-start pt-10 pb-12 lg:flex-row lg:pb-0">
                        ...
                        <div className="w-full lg:w-[350px] relative z-30 lg:mt-0 lg:ml-auto mt-[-100px] sm:mt-[-50px]">
                            ...
                            >
                                <h2 className="mb-6 text-xl font-semibold text-center text-black">Section 8 Company</h2>
