...
const Section8OverviewContent = () => (
    <section id="sec8-overview-content" className="py-12 scroll-mt-24">
        <h2 className="mb-6 text-3xl font-bold text-gray-800">Section 8 Company Registration Overview</h2>
        ...
        <h3 className="mb-6 text-2xl font-bold text-gray-800">Primary Objectives of a Section 8 Company</h3>
...
const Section8BenefitsContent = () => (
    <section id="sec8-benefits-content" className="py-12 scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-gray-800">Benefits of a Section 8 Company</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
...
const Section8EligibilityContent = () => (
    <section id="sec8-eligibility-content" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Eligibility Criteria for Registering a Section 8 Company</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
...
const Section8DocumentsContent = () => (
    <section id="sec8-documents-content" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Forms & Documents Required for Incorporation</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Key Statutory Forms Required:</h4>
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {section8RequiredForms.map((item, i) => (
                <div key={i} className="p-5 bg-white border border-gray-200 rounded-lg shadow-sm">
                    ...
                    <h4 className="mb-1 text-lg font-bold text-gray-800">{item.form}</h4>
                    <p className="text-sm text-gray-600">{item.purpose}</p>
                </div>
            ))}
        </div>

        <h4 className="mt-12 mb-6 text-2xl font-bold text-gray-800">Documents for Directors, Members, and Office</h4>
        <div className="max-w-4xl space-y-3 text-gray-700">
            <p className="flex items-start gap-2 list-none">
                <Users className="flex-shrink-0 w-5 h-5 mt-1 text-indigo-500" />
            ...
            <p className="flex items-start gap-2 list-none">
                <MapPin className="flex-shrink-0 w-5 h-5 mt-1 text-indigo-500" />
            ...
            <p className="flex items-start gap-2 list-none">
                <DollarSign className="flex-shrink-0 w-5 h-5 mt-1 text-indigo-500" />
...
const Section8ProcessContent = () => (
    <section id="sec8-process-content" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Section 8 Company Registration Process</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <h4 className="mt-12 mb-6 text-2xl font-bold text-gray-800">Types of Section 8 Company</h4>
...
const Section8ComplianceLawContent = () => (
    <section id="sec8-compliance-law-content" className="py-12 scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-gray-800">Law, Tax, and Annual Compliance Requirements</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Governing Law and Tax Benefits</h4>
        ...
        <h4 className="mt-12 mb-6 text-2xl font-bold text-gray-800">Key Annual Compliance Requirements</h4>
        <div className="max-w-4xl space-y-3 text-gray-700">
            <p className="flex items-start gap-2 list-none">
                <Clock className="flex-shrink-0 w-5 h-5 mt-1 text-amber-500" />
            ...
            <p className="flex items-start gap-2 list-none">
                <FileText className="flex-shrink-0 w-5 h-5 mt-1 text-amber-500" />
            ...
            <p className="flex items-start gap-2 list-none">
                <Banknote className="flex-shrink-0 w-5 h-5 mt-1 text-amber-500" />
        ...
        <div className="p-6 mt-12 border-l-4 border-red-500 shadow-md bg-red-50 rounded-xl">
            <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><Zap className="w-5 h-5 text-red-500"/> Penalty for Non-Compliance</h4>
...
const Section8WhyVakilsearch = () => (
    <section id="sec8-why-vakilsearch" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Why Vakilsearch for Section 8 Company Registration?</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <div className="mt-12 p-6 bg-[#E6F0F6] rounded-xl border-l-4 border-amber-500 shadow-md">
            <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><DollarSign className="w-5 h-5 text-amber-500"/> Section 8 Company Registration Fees (Approximate)</h4>
...
const Section8FAQsContent = ({ faqs, faqOpen, setFaqOpen }) => (
    <section id="sec8-faqs-content" className="max-w-5xl py-12 mx-auto scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-center text-gray-800">Section 8 Company Registration FAQ's</h3>
        ...
        <div className="bg-white min-h-screen font-[Inter]">
                ...
                <div className="relative px-4 pt-12 mx-auto max-w-7xl md:px-8">
                    ...
                    <div className="relative z-20 flex flex-col items-start pt-10 pb-12 lg:flex-row lg:pb-0">
                        ...
                        <div className="w-full lg:w-[350px] relative z-30 lg:mt-0 lg:ml-auto mt-[-100px] sm:mt-[-50px]">
                            ...
                            >
                                <h2 className="mb-6 text-xl font-semibold text-center text-black">Section 8 Company Registration</h2>
            ...
            <section className="px-4 py-12 bg-gray-50 md:px-8">
                <div className="mx-auto max-w-7xl">
                    <h3 className="mb-8 text-3xl font-bold text-center text-gray-800">Right plan for your NGO</h3>
                    <p className="max-w-4xl mx-auto mb-8 text-lg text-center text-gray-700">
                        Vakilsearch's registration experts guide you through the entire process until you obtain the Section 8 registration.
                    </p>
                    <div className="grid gap-6 md:grid-cols-3">
                        {/* Starter Plan */}
                        <div className="flex flex-col p-6 bg-white border-2 border-gray-200 shadow-lg rounded-xl">
                            <h4 className="mb-2 text-xl font-bold text-gray-800">Starter</h4>
                            <p className="mb-4 text-sm text-gray-600">Ideal for consulting and reserving a name for your NGO</p>
                            ...
                            <button className="w-full py-3 mt-auto font-semibold text-white transition-colors rounded-lg bg-amber-500 hover:bg-amber-600">Get Started</button>
                            <div className="mt-4 text-left">
                                <h5 className="mb-1 text-sm font-bold text-gray-800">What you'll get:</h5>
                        ...
                        <div className="p-6 bg-white rounded-xl shadow-xl border-2 border-[#022B50] relative flex flex-col">
                            <span className="absolute top-0 right-0 px-3 py-1 text-xs font-bold text-white rounded-bl-lg bg-amber-500">Recommended Plan</span>
                            <h4 className="mb-2 text-xl font-bold text-gray-800">Standard</h4>
                            ...
                            <p className="mb-6 text-sm text-gray-600">+ Govt. Fee | EMI option available.</p>
                        ...
                        {/* Premium Plan */}
                        <div className="flex flex-col p-6 bg-white border-2 border-gray-200 shadow-lg rounded-xl">
                            <h4 className="mb-2 text-xl font-bold text-gray-800">Premium</h4>
                            <p className="mb-4 text-sm text-gray-600">Complete End-to-End Solutions for NGOs.</p>
                            <div className="text-3xl font-extrabold text-[#022B50] mb-2">
                            ...
                            <button className="w-full py-3 mt-auto font-semibold text-white transition-colors rounded-lg bg-amber-500 hover:bg-amber-600">Get Started</button>
                            <div className="mt-4 text-left">
                                <h5 className="mb-1 text-sm font-bold text-gray-800">Key Inclusions:</h5>
                                <ul className="space-y-1 text-xs text-gray-600 list-disc list-inside">
                    ...
                    <p className="mt-4 text-sm text-center text-gray-600">Note: Government fees for NGO registration are extra and it varies from state to state. T&C</p>
                </div>
            </section>
