...
const CSR1OverviewContent = () => (
    <section id="csr1-overview-content" className="py-12 scroll-mt-24">
        <h2 className="mb-6 text-3xl font-bold text-gray-800">CSR-1 Registration - A Mechanism for Corporate Social Responsibility Funding</h2>
        ...
        <h3 className="mb-6 text-2xl font-bold text-gray-800">Applicability of Form CSR-1</h3>
        <div className="p-6 bg-[#E6F0F6] rounded-xl shadow-md border-l-4 border-[#022B50]">
            <h4 className="mb-3 text-xl font-bold text-gray-800">Mandatory for Entities Seeking CSR Funding:</h4>
            <ul className="space-y-1 font-medium text-gray-700 list-disc list-inside">
                <li>Section 8 companies</li>
                <li>Public trusts</li>
                <li>Societies registered under Section 12A and 80G of the Income Tax Act, 1961</li>
            </ul>
            <p className="mt-4 text-sm font-semibold text-gray-600">Note: It is **not applicable** to individual beneficiaries, government entities, or foreign organizations.</p>
        </div>
    </section>
);
...
const CSR1EligibilityContent = () => (
    <section id="csr1-eligibility-content" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Eligibility Criteria for CSR-1 Registration</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
...
const CSR1DocumentsContent = () => (
    <section id="csr1-documents-content" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Documents Required & Eligible Types for CSR-1</h3>

        <h4 className="mb-6 text-2xl font-bold text-gray-800">Documents Required for Filing Form CSR-1</h4>
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Types of NGOs Eligible for CSR-1 Registration</h4>
...
const CSR1ProcessContent = () => (
    <section id="csr1-process-content" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Form CSR-1 Filing Process</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Step-by-Step Registration Procedure:</h4>
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Contents of Form CSR-1</h4>
            ...
            <ul className="space-y-3 text-gray-700 list-none">
                {csr1Contents.map((content, i) => (
                    <li key={i} className="flex items-start gap-2">
                        <FileText className="flex-shrink-0 w-5 h-5 mt-1 text-blue-500" />
...
const CSR1LawPurposeContent = () => (
    <section id="csr1-law-purpose-content" className="py-12 scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-gray-800">Governing Law, Importance & Benefits of CSR-1</h3>

        <h4 className="mb-6 text-2xl font-bold text-gray-800">Law Governing the eForm CSR-1</h4>
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Importance and Purpose of Form CSR-1 (Benefits)</h4>
...
const CSR1StatusFeesContent = () => {
    ...
    return (
        <section id="csr1-status-fees-content" className="py-12 scroll-mt-24">
            <h3 className="mb-6 text-3xl font-bold text-gray-800">CSR-1 Registration Status Check & Fees</h3>
            <p className="max-w-4xl mb-8 text-lg text-gray-700">
            ...
            <h4 className="mb-6 text-2xl font-bold text-gray-800">CSR-1 Registration Status Check Procedure:</h4>
            <ol className="pl-4 mb-12 space-y-5 list-none border-l-2 border-amber-500">
                <li className="flex items-start gap-4"><div className="flex items-center justify-center flex-shrink-0 w-8 h-8 font-bold text-white rounded-full bg-amber-500">1</div><span className="text-lg text-gray-700">Visit the MCA Portal and Log in using your credentials.</span></li>
                <li className="flex items-start gap-4"><div className="flex items-center justify-center flex-shrink-0 w-8 h-8 font-bold text-white rounded-full bg-amber-500">2</div><span className="text-lg text-gray-700">Navigate to 'Check Annual Filing Status' option under 'MCA Services.'</span></li>
                <li className="flex items-start gap-4"><div className="flex items-center justify-center flex-shrink-0 w-8 h-8 font-bold text-white rounded-full bg-amber-500">3</div><span className="text-lg text-gray-700">Select Form CSR-1 and enter the **CIN (Corporate Identity Number)** or the **SRN (Service Request Number)** from registration.</span></li>
                <li className="flex items-start gap-4"><div className="flex items-center justify-center flex-shrink-0 w-8 h-8 font-bold text-white rounded-full bg-amber-500">4</div><span className="text-lg text-gray-700">The system will show the current status of the CSR-1 registration application.</span></li>
            </ol>

            <h4 className="mb-6 text-2xl font-bold text-gray-800">Form CSR-1 Filing Fees</h4>
            <div className="grid gap-6 md:grid-cols-2">
...
const CSR1FAQsContent = ({ faqs, faqOpen, setFaqOpen }) => (
    <section id="csr1-faqs-content" className="max-w-5xl py-12 mx-auto scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-center text-gray-800">CSR-1 Registration FAQs</h3>
                    ...
                    <div className="relative z-20 flex flex-col items-start pt-10 pb-12 lg:flex-row lg:pb-0">
                        ...
                        <div className="relative z-20 w-full p-4 pb-20 text-black lg:w-3/5 md:p-6">
                            ...
                            <nav className="mb-3 text-sm text-gray-800">
                                ...
                                <span className="cursor-pointer hover:underline">NGO Registration</span> &gt;{" "}
                        ...
                        <div className="w-full lg:w-[350px] relative z-30 lg:mt-0 lg:ml-auto mt-[-100px] sm:mt-[-50px]">
                            ...
                            >
                                <h2 className="mb-6 text-xl font-semibold text-center text-black">CSR-1 Registration</h2>
