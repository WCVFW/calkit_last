...
const SocietyOverviewContent = () => (
    <section id="society-overview-content" className="py-12 scroll-mt-24">
        <h2 className="mb-6 text-3xl font-bold text-gray-800">Online Society Registration in India - An Overview</h2>
        ...
        <h3 className="mb-6 text-2xl font-bold text-gray-800">What is Society and Society Registration?</h3>
        <div className="grid gap-6 md:grid-cols-2">
            <div className="p-5 bg-[#E6F0F6] rounded-xl shadow-md border-l-4 border-[#022B50]">
                <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><Users className="w-6 h-6 text-[#022B50]"/> What is Society?</h4>
            ...
            <div className="p-5 bg-[#E6F0F6] rounded-xl shadow-md border-l-4 border-[#022B50]">
                <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><Landmark className="w-6 h-6 text-[#022B50]"/> What is Society Registration?</h4>
...
const SocietyBenefitsContent = () => (
    <section id="society-benefits-content" className="py-12 scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-gray-800">Benefits of Registering a Society</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
...
const SocietyEligibilityContent = () => (
    <section id="society-eligibility-content" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Eligibility Criteria for Society Registration</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <h4 className="mt-12 mb-6 text-2xl font-bold text-gray-800">Common Reasons for Society Registration</h4>
        <div className="grid max-w-5xl gap-4 text-gray-700 sm:grid-cols-2 lg:grid-cols-3">
            <p className="flex items-start gap-2"><ArrowRight className="flex-shrink-0 w-4 h-4 mt-1 text-amber-500" /> To support arts, literature and science promotion.</p>
            <p className="flex items-start gap-2"><ArrowRight className="flex-shrink-0 w-4 h-4 mt-1 text-amber-500" /> Political education dissemination.</p>
            <p className="flex items-start gap-2"><ArrowRight className="flex-shrink-0 w-4 h-4 mt-1 text-amber-500" /> Establishing funds for military orphans.</p>
            <p className="flex items-start gap-2"><ArrowRight className="flex-shrink-0 w-4 h-4 mt-1 text-amber-500" /> Building public museums and galleries.</p>
            <p className="flex items-start gap-2"><ArrowRight className="flex-shrink-0 w-4 h-4 mt-1 text-amber-500" /> Promotion of useful knowledge and construction of public libraries.</p>
            <p className="flex items-start gap-2"><ArrowRight className="flex-shrink-0 w-4 h-4 mt-1 text-amber-500" /> Assemblages of mechanical and philosophical designs.</p>
        </div>
    </section>
);
...
const SocietyDocumentsProcessContent = () => (
    <section id="society-documents-process-content" className="py-12 scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-gray-800">Documents Required & Step-by-Step Process</h3>

        <h4 className="mb-6 text-2xl font-bold text-gray-800">Documents Required for Society Registration Online</h4>
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Step-by-Step Society Registration Online Process</h4>
        ...
        <div className="p-6 mt-12 bg-white border border-gray-200 shadow-lg rounded-xl">
            <h4 className="text-2xl font-bold mb-4 text-[#022B50]">Society Registration Fees and Timeline</h4>
            <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-3">
                    <p className="font-semibold text-gray-700">Government Fee (Varies by State): <span className="font-bold text-red-500">₹500 to ₹1,500</span></p>
                    <p className="font-semibold text-gray-700">Professional/Consultant Charges: <span className="font-bold text-red-500">₹2,000 to ₹10,000 (Optional)</span></p>
                    <p className="font-semibold text-gray-700">Total Time Estimate: <span className="font-bold text-[#022B50]">2 to 4 weeks</span></p>
                </div>
                <div className="pl-4 space-y-3 border-l border-gray-200">
                    <p className="text-sm text-gray-600">Document Preparation & Filing: 2 to 5 working days</p>
                    <p className="text-sm text-gray-600">Government Processing & Approval: 15 to 30 working days</p>
                    <p className="text-sm italic text-gray-600">Note: Fees for ISO 45001 certification may vary.</p>
                </div>
            </div>
        </div>
    </section>
...
const SocietyComplianceRenewalContent = () => (
    <section id="society-compliance-renewal-content" className="py-12 scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-gray-800">Compliance After Registration & Renewal Process</h3>

        <h4 className="mb-6 text-2xl font-bold text-gray-800">Post-Registration Compliance Obligations</h4>
        <div className="grid gap-6 mb-12 md:grid-cols-2">
            {societyPostRegistrationCompliance.map((item, i) => (
                <div key={i} className="flex items-start gap-4 p-4 bg-white border-l-4 rounded-lg shadow-md border-amber-500">
                    <item.icon className="flex-shrink-0 w-5 h-5 mt-1 text-amber-500" />
                    <div>
        ...
        <h4 className="mb-6 text-2xl font-bold text-gray-800">Society Registration Renewal Online Process</h4>
        <ul className="pl-4 space-y-5 list-none border-l-2 border-green-500">
...
const SocietyWhyVakilsearch = () => (
    <section id="society-why-vakilsearch" className="py-12 scroll-mt-24">
        <h3 className="mb-6 text-3xl font-bold text-gray-800">Why Vakilsearch for Society Registration?</h3>
        <p className="max-w-4xl mb-8 text-lg text-gray-700">
        ...
        <div className="mt-12 p-6 bg-[#E6F0F6] rounded-xl border-l-4 border-amber-500 shadow-md">
            <h4 className="flex items-center gap-2 mb-2 text-xl font-bold text-gray-800"><Lightbulb className="w-5 h-5 text-amber-500"/> Recent Legal Updates</h4>
...
const SocietyFAQsContent = ({ faqs, faqOpen, setFaqOpen }) => (
    <section id="society-faqs-content" className="max-w-5xl py-12 mx-auto scroll-mt-24">
        <h3 className="mb-8 text-3xl font-bold text-center text-gray-800">FAQ's on Online Society Registration India</h3>
